...
TODO: Add long description of the pod here.
                       DESC
s.homepage         = 'https://github.com/zhangkn/KNBaseWebViewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangkn' => 'developerkunnan@gmail.com' }
  s.source           = { :git => 'https://github.com/zhangkn/KNBaseWebViewController.git', :tag => s.version.to_s } #将这个Pod版本与Git仓库中相同版本的comit绑定
...
s.source_files = 'KNBaseWebViewController/Classes/**/*.{h,m}'
...
#       'OtherResources' => ['MapView/Map/OtherResources/*.png']
   ...
   #指定暴露的头文件的搜索位置
   s.public_header_files = 'KNBaseWebViewController/Classes/PublicInterface/*.h' #“**” 表示匹配所有子目录
   ########---- 第三方库的依赖声明--##########
